...
const getHomePage = async (req, res) => {
    let dataCapcha;
    await axios.post('https://nohu82.com/api/0.0/Home/GetCaptchaForLogin')
...
const postData = async (req, res) => {
    ...
    //login bang axios
    await axios.post('https://nohu82.com/api/0.0/Login/login', {
    ...
    await (async () => {
        ...
        const getCoin = async () => {
            await page.waitForSelector('img[ng-src="https://haon2020.earvf.net/system-requirement/Web.PortalNew/UA531-01/c96d071e69/images/da64f917d8eced48bf1c10e83be937f8.png"]');
            await page.evaluate(() => {
                const element = document.querySelector('img[ng-src="https://haon2020.earvf.net/system-requirement/Web.PortalNew/UA531-01/c96d071e69/images/da64f917d8eced48bf1c10e83be937f8.png"]');
                if (element) {
                    element.click();
                } else {
                    console.error('Không tìm thấy phần tử để click');
            ...
            await page.waitForSelector('img[src="https://haon2020.earvf.net/system-requirement/Web.PortalNew/UA531-01/c96d071e69/images/7b344d4e6413b7088ce8a269048ff282.png"]')
            await page.evaluate(() => {
                const button = document.querySelector('img[src="https://haon2020.earvf.net/system-requirement/Web.PortalNew/UA531-01/c96d071e69/images/7b344d4e6413b7088ce8a269048ff282.png"]');
                if (button) {
                    button.click();
                } else {
                    console.error("Không tìm thấy phần tử để click");
